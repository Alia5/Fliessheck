...
// stolen from: https://ybogomolov.me/type-level-uuid/
// adapted to to more lineant approach, meaing UUID resolves to just a type alias if the type-argument is omitted.
...
export type UUID<S extends string = string> = string extends S ? S : S extends NilUUID
    ? S
